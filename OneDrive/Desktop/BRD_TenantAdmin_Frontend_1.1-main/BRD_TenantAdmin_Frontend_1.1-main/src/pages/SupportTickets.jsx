  ...
  return (
    <div className="p-8 min-h-screen bg-slate-50 font-sans">
      <div className="flex justify-between items-center mb-8">
         ...
         <button onClick={() => setShowModal(true)} className="flex items-center gap-2 px-5 py-3 bg-primary-600 text-white rounded-xl font-bold shadow-lg hover:bg-primary-700 transition">
            <PlusIcon className="h-5 w-5" /> New Ticket
         </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
         ...
         <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
             <div className="bg-orange-100 p-3 rounded-xl text-orange-600"><ClockIcon className="h-6 w-6"/></div>
         ...
         <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
             <div className="bg-emerald-100 p-3 rounded-xl text-emerald-600"><CheckCircleIcon className="h-6 w-6"/></div>
         ...
         <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
             <div className="bg-blue-100 p-3 rounded-xl text-blue-600"><ChatBubbleLeftRightIcon className="h-6 w-6"/></div>
               ...
               {loading ? <tr><td colSpan="6" className="p-8 text-center animate-pulse">Loading...</td></tr> : 
                ...
                tickets.map(t => (
                  <tr key={t.id} className="hover:bg-slate-50 cursor-pointer">
                     ...
                     <td className="px-6 py-4 text-xs font-bold text-slate-500 uppercase">{t.category}</td>
                     ...
                     <td className="px-6 py-4 text-xs text-slate-400 font-medium">{t.updated_at}</td>
                  </tr>
                ))}
            </tbody>
         </table>
